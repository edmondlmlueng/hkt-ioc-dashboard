...
with col_video:
    ...
    st.image("https://picsum.photos/id/1015/800/450", width=800, caption="Live Feed (Demo)")
    ...
    try:
        ...
        if image_files:
            ...
            for file in image_files[:6]:
                st.image(f"https://drive.google.com/uc?id={file['id']}", caption=file['name'], width=700)
        else:
